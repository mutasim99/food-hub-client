          ...
          <div className="flex flex-col space-y-8 text-center lg:text-left">
            <div>
              ...
              <p className="mt-6 text-lg text-zinc-600 dark:text-zinc-400 max-w-xl mx-auto lg:mx-0 leading-relaxed">
                Browse hundreds of local providers, order your favorite meals,
                and track them in real-time. From kitchen to your doorstep in{" "}
                <span className="text-zinc-900 dark:text-zinc-200 font-semibold underline decoration-orange-500/30">
                  minutes
                </span>
                .
              </p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
              <div className="flex -space-x-3">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="h-10 w-10 rounded-full border-4 border-white dark:border-[#050505] bg-zinc-200 overflow-hidden"
                  >
              ...
              <div className="text-left">
                <div className="flex items-center gap-1 text-orange-500">
                  ...
                  <span className="ml-1 font-bold text-zinc-900 dark:text-white text-sm">
                    4.9/5
                  </span>
                </div>
                <p className="text-xs text-zinc-500 dark:text-zinc-500">
                  from 2,000+ happy foodies
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="relative z-10 w-full aspect-4/5 lg:aspect-square max-w-2xl mx-auto">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white dark:bg-zinc-900 shadow-2xl rounded-2xl p-5 flex items-center gap-4 border border-zinc-100 dark:border-zinc-800 animate-bounce-slow">
                ...
                <div className="pr-4">
                  <p className="font-black text-xl text-zinc-900 dark:text-white leading-none">
                    200+
                  </p>
              ...
              <div className="absolute top-10 -right-8 bg-white dark:bg-zinc-900 shadow-2xl rounded-2xl p-4 flex items-center gap-3 border border-zinc-100 dark:border-zinc-800 animate-float">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-zinc-500 tracking-tighter">
                    Under 30 Minutes
                  </p>
                </div>
              </div>
