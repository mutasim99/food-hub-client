  ...
  const benefits = [
    {
      ...
      text: "Instant storefront setup",
    },
    {
      icon: <Rocket className="text-orange-500" size={18} />,
        ...
        <div className="lg:col-span-5 space-y-8 pt-6">
          <div className="space-y-4">
            ...
            <p className="text-zinc-500 dark:text-zinc-400 text-lg leading-relaxed">
              Join FoodHub's elite network of providers. We provide the tools;
              you provide the flavor.
            </p>
          </div>
          ...
          <div className="space-y-4">
            {benefits.map((benefit, i) => (
              <div
                key={i}
                className="flex items-center gap-3 p-4 rounded-2xl bg-white dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800 shadow-sm"
              >
                {benefit.icon}
          ...
          <div className="p-6 rounded-[2rem] bg-orange-500/5 border border-orange-500/10">
            <p className="text-sm text-orange-600 dark:text-orange-400 italic">
              "Joining FoodHub increased our monthly orders by 40% in just two
              months."
            </p>
